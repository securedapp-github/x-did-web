    ...
    <div id="top" className="service-container">
      <MetaTags
        data={{
          ...
          desc:
            "Secure your business with Blockchain Identity Verification for KYC and compliance. Trusted by 120+ companies in DeFi, NFTs, and crypto exchanges.",
          keywords:
      ...
      <div className="bg-grid-navy">
            ...
            <div className="mt-6 sm:mt-8">
              <div className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-cardBgLight dark:bg-cardBgDark p-6 sm:p-8 lg:p-10 transition-all duration-300 cursor-pointer hover:!border-[#12d576] hover:shadow-brandLg hover:-translate-y-2 active:scale-[0.98]">
                <p className="text-white/90 dark:text-white/90 light:text-gray-700 leading-relaxed">
                  Today’s digital world is broken when it comes to identity. Every new service asks for fresh accounts, passwords, and sensitive data; creating huge risks of breaches, identity theft, and user tracking. Enterprises carry massive compliance and liability burdens by storing personal information they don’t even need.
                </p>
                <p className="mt-4 text-white/90 dark:text-white/90 light:text-gray-700 leading-relaxed">
                  SecureX-DID flips this model. By decentralizing identity, it eliminates single points of failure, cuts down on redundant verifications, and ensures privacy by design. It’s not just a product, it’s a shift toward <span className="font-semibold">self-sovereign identity</span>, where individuals own their data and businesses can trust verified credentials without storing them.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="services" className="py-12 sm:py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <SectionTitle name={"Services"} title={"Deep Dive into our Services"} />
              ...
              <div className="overflow-x-auto">
                <table className="min-w-[720px] w-full table-auto text-left text-sm">
                  ...
                  <tbody className="divide-y divide-gray-200/30 dark:divide-white/10">
                    {[
                      { k: "Decentralized Identity", l: "Product Description, Benefits Intro, FAQs, Deep Dive (User & Enterprise)" },
                      { k: "Zero Knowledge Proof", l: "Product Description, Benefits, FAQs, Strategic Rationale" },
                      ...
                      { k: "Blockchain Authentication", l: "Benefits, FAQs, Deep Dive (Developer)" },
                      { k: "Identity Verification", l: "Benefits, FAQs, Deep Dive (Enterprise)" },
                      { k: "Data Protection", l: "Benefits, FAQs" },
                      { k: "Secure Login", l: "Product Description, FAQs, Deep Dive (User)" },
                      { k: "User Anonymity", l: "Benefits, Deep Dive (User)" },
                    ].map((row) => (
                      <tr key={row.k} className="hover:bg-white/5">
                        <td className="py-3 px-4 align-top text-white/90 dark:text-white/90 light:text-gray-800">{row.k}</td>
                        <td className="py-3 px-4 align-top text-white/70 dark:text-white/70 light:text-gray-700">{row.l}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
